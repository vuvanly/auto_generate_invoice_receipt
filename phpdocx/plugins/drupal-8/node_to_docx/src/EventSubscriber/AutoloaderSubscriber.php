...
class AutoloaderSubscriber implements EventSubscriberInterface {
  ...
  /**
   * Returns the absolute path to the AutoLoad.inc file. If AutLoad.inc does not exist return false
   *
   * @return string
   */
  public function getAutoloadFilepath() {
    $module_path = DRUPAL_ROOT . '/' . drupal_get_path('module', 'node_to_docx') . '/phpdocx/Classes/Phpdocx/AutoLoader.inc';
    $library_path = DRUPAL_ROOT . '/libraries/phpdocx/Classes/Phpdocx/AutoLoader.inc';
